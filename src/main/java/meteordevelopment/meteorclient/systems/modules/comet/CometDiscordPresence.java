...
public class CometDiscordPresence extends Module {
    ...
    public CometDiscordPresence() {
        super(Categories.Comet, "Comet Presence", "Displays Meteor Dev as your presence on Discord.");
    ...
    public void onActivate() {
        DiscordIPC.start(984097161291649024L, null);

        rpc.setStart(System.currentTimeMillis() / 1000L);

        String largeText = "Meteor Developer | Dev build: " + MeteorClient.DEV_BUILD;
        rpc.setLargeImage("logo", largeText);
